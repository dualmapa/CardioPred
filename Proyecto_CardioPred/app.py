...
def load_model_and_pipeline():
    ...
    try:
        model = joblib.load('models/cardio_pred_model.pkl')
        return model
...
if pipeline is None:
    st.error("❌ Error Crítico: No se encuentra el archivo 'models/cardio_pred_model.pkl'. Asegúrate de haberlo descargado del notebook y colocado en la carpeta correcta.")
    st.stop()
